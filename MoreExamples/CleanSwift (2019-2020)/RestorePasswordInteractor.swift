...
protocol RestorePasswordBusinessLogic {
    func initialSetup(request: RestorePassword.InitialSetup.Request)
    func restore(request: RestorePassword.Restore.Request)
}

protocol RestorePasswordDataStore {
    var email: String? { get set }
}

class RestorePasswordInteractor: RestorePasswordBusinessLogic, RestorePasswordDataStore {
